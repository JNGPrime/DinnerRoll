...
async function initStripe() {
  ...
  try {
    ...
    // Only set up managed webhook if we have a domain
...
(async () => {
  ...
  // Serve static files from public folder (family.html, date.html, profile.html, etc.)
  const publicPath = path.resolve(import.meta.dirname, "..", "public");
  app.use(express.static(publicPath, { index: false }));

  // Serve the static home page at root in both dev and production
  app.get("/", (_req, res) => {
